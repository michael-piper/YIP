...
class AdminController extends Controller
{
        //
        function addProduct(){
            return view('dashboard.admin.addproduct');
        }
        function products(){
        ...
        function product(Request $request, $product_id){
            ...
            return view('dashboard.admin.product')->with(['product'=>$product,'currency'=>Product::currency()]);
        }
        function editProduct($product_id){
            ...
            if(is_null($product))
                return redirect()->intended('dashboard/products?m='.urlencode('product with #'.$product_id.' not available on your list'))->with('error', 'user not loged in!');
            return view('dashboard.admin.editproduct')->with(['body'=>$product]);
        }
        function doAddProduct(Request $request){
            ...
            return view('dashboard.admin.addproduct')->with([$message_type=>$message,'body'=>$credentials]);
        }
        function doEditProduct(Request $request){
            ...
            return view('dashboard.admin.editproduct')->with([$message_type=>$message,'body'=>$credentials]);
        }
}
