 ...
 <div class="uk-card radius uk-card-default uk-width-1-1@m" >
    <div class="uk-card-header uk-padding-small" style="padding-top:10px;padding-bottom:10px;">
        <div class="uk-grid-small uk-flex-middle" uk-grid>
                <h3 class="uk-card-title uk-margin-remove-bottom">Frequently buy Items</h3>
        </div>
    </div>
    <div class="uk-card-body uk-padding-remove" style="background:url(/images/sliders/1.jpg); background-size:cover;" >
